...
rd1.addEventListener("click", function () {
    ...
    r1.innerHTML = '<span>' + point + 'Hp折抵Nt' + point/100 + '</span> <a href="#" id="pay-cancel1">X取消</a>';
    r2.innerHTML = "";
    money1.innerHTML = "NT$" + (totalprice - point / 100).toString();
    money2.innerHTML = "NT$" + (totalprice - point / 100).toString();
...
rd2.addEventListener("click", function () {
    ...
    money1.innerHTML = "NT$" + (totalprice /1).toString();
    money2.innerHTML = "NT$" + (totalprice /1).toString();
