    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult RegisterTacheyMember()
        {
            using (TacheyContext context = new TacheyContext())
            {
                ...
                Member member = new Member { MemberID = User.Identity.GetUserId(), Email = email,Name="匿名", JoinTime = DateTime.Now,Photo= "https://lh3.googleusercontent.com/proxy/OXfpYhZBwg2BRO2Po_gPGwkVLmYVNowH3Va_q5fk62d0dNB9lusU3K79z8QihWT1BCr6XAHN_MaB1Ofw0GtaXjxEPx4HG22LLhAM1lGKRDQbQvkbYEM" };
